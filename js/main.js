...
['Incêndios', 'Homicídios', 'Genocídios', 'Subsídios', 'Seios', 'Interlúdios', 'Latifúndios', 'Dispêndios', 'Selênios', 'Triênios', 'Betos e Ênios', 'Compêndios', 'Compêndio', 'Assédios'],
...
['Dissolvido', 'Evaporado', 'Desfeito', 'Desligado', 'Dido-dido', 'Diluído', 'Traído', 'Vivido', 'Sabido', 'Polido', 'Resolvido', 'Bebido', 'Instruído', 'Cozido'],
['Finalmente', 'Incondicionalmente', 'Gradativamente', 'Ultimamente', 'Recentemente', 'Dualisticamente', 'Eternamente', 'Temente', 'Esporadicamente', 'Infelizmente', 'Inconstitucionalissimamente', 'Redondamente', 'Enfadonhamente', 'Bovinamente'],
['Restam cinzas', 'Gastam as pingas', 'Com ojerizas', 'Restam lindas', 'E as ranzinzas', 'Restam balizas', 'Restam dindas', 'Difundidas', 'Sobram milhas', 'Restam ranzinzas', 'Bebi em Minas', 'Bazingas', 'Somos Maisas', 'Restam lendas'],
['Que espalho na cama', 'Que jogo na lama', 'Que boto em cana', 'Que vejo a trama', 'Que divido a cama', 'Que molho a cama', 'Que solto a escama', 'Embaixo da cama', 'Que rolo na cama', 'Pulando na cama', 'Deserto atacama', 'Chamo o Ibama', 'Que monto na lhama', 'Que minto minha fama'],
